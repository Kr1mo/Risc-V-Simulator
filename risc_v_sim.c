...
int main(int argc, char **argv) {
  char *source_state = "states/fill_memory.state"; // Special for this branch: A
                                                   // standard state to use :)
  char *end_state = NULL;
  int n_cycles = -1;
  ...
  //  }
  //  if (strcmp(file_extension, ".state")) { // file extension is NOT .state
  //    printf("Wrong file extension for initial state, expected .state, got
  //    %s\n",
  //           file_extension);
  //    return 1;
  //  }
